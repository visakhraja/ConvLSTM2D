...
train_start, train_end = '2009-01-05', '2011-09-30'
validation_start, validation_end = '2007-12-04', '2009-01-01'
test_start, test_end = '2007-01-05', '2007-11-30'
prediction_start, prediction_end = '2003-01-01', '2011-12-28'
lookback_window = 3
days_after = 3
...
# Load the model
loaded_model = tf.keras.models.load_model('/p/scratch/share/sivaprasad1/visakh/code/convlstm_model_amsre_20241106_rev')
...
# plt.plot(Y_test[:,130,250], label='True')
# plt.plot(predictions[:,130,250], label='Predicted')
# plt.legend()
# # Save the figure
# plt.savefig('/p/scratch/share/sivaprasad1/visakh/code/predictions_plot4.png')  # Specify the path and filename
...
dataset.to_netcdf('/p/scratch/share/sivaprasad1/niesel1/EU_DATA/predictions_2003_2011_20250814.nc')
