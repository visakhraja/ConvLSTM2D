...
train_start, train_end = '2016-10-03', '2023-12-22'
validation_start, validation_end = '2013-10-03', '2016-10-02'
...
def build_model(input_shape):
    model = Sequential([
        ...
        #LeakyReLU(),
        BatchNormalization(),
        ConvLSTM2D(filters=16, kernel_size=(3, 3), padding='same', return_sequences=True, 
                   dropout=0.2, recurrent_dropout=0.2),
        BatchNormalization(),
        #LeakyReLU(),
        ConvLSTM2D(filters=8, kernel_size=(3, 3), padding='same', return_sequences=False, 
                   dropout=0.2, recurrent_dropout=0.2),
        BatchNormalization(),
        #LeakyReLU(),
...
checkpoint_path = "/p/scratch/share/sivaprasad1/visakh/model_checkpoint_6"
...
# set_global_policy('float32')
#save the model 
model.save('convlstm_model_6')

# #save model weights
model.save_weights('convlstm_model_weights_6')
